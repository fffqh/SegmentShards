...
from segment_anything_adv import SamImgembTargetAdversarialGenerator,sam_model_registry
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default="config/error.yaml", type=str, help='config file')
    ...
    advout_path_params += '_' + point_per_side + '_' + point_per_batch + '_' + stb + '_npa'
    ...
    adv_generator = SamImgembTargetAdversarialGenerator(
                        sam,
    ...
    for i, data in enumerate(dataloader):
        ...
        adv_mask, adv_img = adv_generator.run(img, tg_img)
