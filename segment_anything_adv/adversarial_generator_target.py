...
class SamTargetAdversarialGenerator:
    def __init__(
        self,
        model: Sam,
    ...
    def run(
        ...
        for crop_box, layer_idx in zip(crop_boxes, layer_idxs):
            ...
            for (points,) in batch_iterator(self.points_per_batch, points_for_image):
                ...
                ## 进行攻击
                masks, iou_preds, _, adv_img_torch = self._attack(im_torch, im_torch_ori, im_torch_target, points_torch_tuple)
    ...
    def _attack(
        ...
        return masks, iou_predictions, low_res_masks, im_torch
