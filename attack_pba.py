...
from segment_anything_adv import SamBmTargetAdversarialGenerator,sam_model_registry

#yaml_path = "./config/base_advITCVD_E1.yaml"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default="config/base.yaml", type=str, help='config file')
    ...
    advout_path_params += '_' + point_per_side + '_' + point_per_batch + '_' + stb + '_pbam'
    ...
    adv_generator = SamBmTargetAdversarialGenerator(
                        sam,
    ...
    for i, data in enumerate(dataloader):
        ...
        adv_img = adv_generator.run(img, tg_img)
